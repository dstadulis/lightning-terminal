...
require (
	...
	github.com/lightninglabs/taproot-assets v0.4.0-rc1.0.20240711112107-be882ced5874
	github.com/lightningnetwork/lnd v0.18.0-beta.rc4.0.20240711100020-374b659476ac
